...
q\left(x_{t} \mid x_{0}\right) & =\mathcal{N}\left(x_{t} ; \sqrt{\alpha_{t}} x_{0},\left(1-\bar{\alpha}_{t}\right) \mathbf{I}\right) \tag{50}
\end{align}
$$
...
= \frac{\sqrt{\alpha_{t}}\left(1-\bar{\alpha}_{t-1}\right) x_{t}+\sqrt{\alpha_{t-1}}\left(1-\alpha_{t}\right) \hat{x}_{\theta}(x_t,t)}{1-\bar{\alpha}_{t}} \quad\quad(58)
\end{align}
$$
