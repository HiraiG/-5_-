...
& =\frac{ \sqrt{\alpha_t\bar{\alpha}_t} \left(1-\bar{\alpha}_{t-1}\right) x_t + \sqrt{\alpha_{t-1}} \left(1-\alpha_t\right) x_t - \sqrt{\alpha_{t-1}(1-\bar{\alpha}_t)} \left(1-\alpha_t\right) \varepsilon }{\sqrt{\bar{\alpha}_t}(1-\bar{\alpha}_t)}\\
...
$$
\begin{align}
\frac{\sqrt{\alpha_t}\left(1-\bar{\alpha}_{t-1}\right) x_t+\sqrt{\alpha_{t-1}}\left(1-\alpha_t\right) \frac{x_t-\sqrt{1-\bar{\alpha}_t} \varepsilon}{\sqrt{\alpha_t\bar{\alpha}_{t-1}}}}{1-\bar{\alpha}_t}
\end{align}
$$

$$
\begin{align}
\frac{\sqrt{\alpha_t}\left(1-\bar{\alpha}_{t-1}\right) x_t+\sqrt{\alpha_{t-1}}\left(1-\alpha_t\right) \frac{x_t-\sqrt{1-\bar{\alpha}_t} \varepsilon}{\sqrt{\alpha_t\bar{\alpha}_{t-1}}}}{\cancel{1-\bar{\alpha}_t}} \cdot \frac{\cancel{1-\bar{\alpha}_t}}{1-\bar{\alpha}_t}
\end{align}
$$

$$
\begin{align}
\frac{ \sqrt{\alpha_t\bar{\alpha}_t} \left(1-\bar{\alpha}_{t-1}\right) x_t + \sqrt{\alpha_{t-1}} \left(1-\alpha_t\right) x_t - \sqrt{\alpha_{t-1}(1-\bar{\alpha}_t)} \left(1-\alpha_t\right) \varepsilon }{1-\bar{\alpha}_t}
\end{align}
$$

$$
\begin{align}
\frac{ \sqrt{\alpha_t\bar{\alpha}_t} \left(1-\bar{\alpha}_{t-1}\right) x_t + \sqrt{\alpha_{t-1}} \left(1-\alpha_t\right) x_t - \sqrt{\alpha_{t-1}(1-\bar{\alpha}_t)} \left(1-\alpha_t\right) \varepsilon }{ \cancel{1-\bar{\alpha}_t}} \cdot \frac{\cancel{1-\bar{\alpha}_t}}{1-\bar{\alpha}_t}
\end{align}
$$

$$
\begin{align}
\frac{ \sqrt{\alpha_t\bar{\alpha}_t} \left(1-\bar{\alpha}_{t-1}\right) x_t + \cancel{\sqrt{\alpha_{t-1}} \left(1-\alpha_t\right) x_t} - \sqrt{\alpha_{t-1}(1-\bar{\alpha}_t)} \left(1-\alpha_t\right) \varepsilon }{ \cancel{1-\bar{\alpha}_t}} \cdot \frac{\cancel{1-\bar{\alpha}_t}}{1-\bar{\alpha}_t}
\end{align}
$$
